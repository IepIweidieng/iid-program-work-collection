...
long long *strassen(long long n, long long a[], long long b[], long long *c) {
  ...
  // compute m1 ~ m7
  m1 = strassen(n/2, add(n/2, a11, a22, aa), add(n/2, b11, b22, bb), m1);

  m2 = strassen(n/2, add(n/2, a21, a22, aa), b11, m2);

  m3 = strassen(n/2, a11, sub(n/2, b12, b22, bb), m3);

  m4 = strassen(n/2, a22, sub(n/2, b21, b11, bb), m4);

  m5 = strassen(n/2, add(n/2, a11, a12, aa), b22, m5);

  m6 = strassen(n/2, sub(n/2, a21, a11, aa), add(n/2, b11, b12, bb), m6);

  m7 = strassen(n/2, sub(n/2, a12, a22, aa), add(n/2, b21, b22, bb), m7);

  // combine c matrix
  c11 = add(n/2, sub(n/2, add(n/2, m1, m4, aa), m5, bb), m7, c11);
  c12 = add(n/2, m3, m5, c12);
  c21 = add(n/2, m2, m4, c21);
  c22 = add(n/2, sub(n/2, add(n/2, m1, m3, aa), m2, bb), m6, c22);
