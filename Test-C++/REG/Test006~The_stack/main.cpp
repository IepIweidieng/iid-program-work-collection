    ...
    switch (Input){
      case 1:
        ...
        if(Output!=NULL){
          ...
          cin>>*Output;
          cout<<"=>The integer "<<*Output<<" has been pushed into the stack."<<endl;
        }
        break;
      case 2:
        Output=Pop();
        if(Output!=NULL){cout<<"=>The integer "<<*Output<<" has been pop out of the stack."<<endl;}
        break;
      case 3:
        ShowStack();
        break;
